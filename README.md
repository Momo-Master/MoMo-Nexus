...
│  │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐               ││
│  │  │ 🟢 MoMo  │  │🟢 Ghost  │  │ 🟡 Mimic │  │ 🔴 Swarm │               ││
│  │  │ Online   │  │ Bridge   │  │ Sleeping │  │ Offline  │               ││
│  │  │ 2h ago   │  │ 5m ago   │  │ 1h ago   │  │ 3d ago   │               ││
│  │  └──────────┘  └──────────┘  └──────────┘  └──────────┘               ││
│  └─────────────────────────────────────────────────────────────────────────┘│
│                                                                              │
│  ┌─────────────────────────────┐  ┌─────────────────────────────┐          │
│  │  📍 DEVICE MAP              │  │  📊 CHANNEL STATUS          │          │
│  │                              │  │                             │          │
│  │  ┌─────────────────────┐    │  │  LoRa    ████████░░  80%   │          │
│  │  │                     │    │  │  4G      ██████████  100%  │          │
│  │  │    [Map with        │    │  │  WiFi    ██████░░░░  60%   │          │
...
│  │  📨 RECENT MESSAGES                                                     ││
│  │                                                                          ││
│  │  🔔 10:32  MoMo      Handshake captured: CORP-WiFi                     ││
│  │  🔔 10:28  Ghost     New client connected: 192.168.1.50                ││
│  │  ⚡ 10:15  Nexus     Channel 4G restored                               ││
│  │  🔔 09:45  MoMo      Password cracked: Summer2024!                     ││
│  │                                                                          ││
│  └─────────────────────────────────────────────────────────────────────────┘│
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
